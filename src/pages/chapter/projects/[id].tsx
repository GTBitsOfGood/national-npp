...
function ChapterProjectPage({ project }: Props) {
  ...
  const nonprofit = tempProject.nonprofit as Nonprofit;

  const viewApplicationForm = true;
  const viewFeedbackForm = true;
            ...
            <VStack alignItems="flex-start" maxW="100%" m={10} spacing={5}>
              ...
              <VStack align="flex-start" spacing={0}>
                <Button
                  ...
                  colorScheme="blue"
                  variant="ghost"
                  onClick={() => window.open(`mailto:${nonprofit.email}`)}
                  p={0}
                  _hover={{ bgColor: "none" }}
                >
                  Contact Nonprofit
                ...
                {viewApplicationForm && (
                  <Button
                    ...
                    colorScheme="blue"
                    variant="ghost"
                    onClick={() => console.log("go to application form")}
                    p={0}
                    _hover={{ bgColor: "none" }}
                  >
                ...
                {viewFeedbackForm && (
                  <Button
                    ...
                    colorScheme="blue"
                    variant="ghost"
                    onClick={() => console.log("go to feedback form")}
                    p={0}
                    _hover={{ bgColor: "none" }}
                  >
                    View Feedback Form
...
export default ChapterProjectPage;
